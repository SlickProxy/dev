namespace SlickProxyLib
{
    ...
    public class SlickProxySettings
    {
        ...
        internal Action<string, string, bool> OnRewritingStarted { set; get; }

        internal Action<string, string> OnProcessingEnded { set; get; }

        internal Action<string, string> OnRewriteToCurrentServer { set; get; }

        internal Action<string, string> OnRedirectTo { set; get; }

        internal Action<string, string, HttpRequestMessage, Exception> OnRewritingException { set; get; }

        internal Action<string, string> OnRewriteToDifferentServer { get; set; }

        internal Action<string> OnNoMatching { get; set; }

        internal Action<string, string, HttpRequestMessage, HttpResponseMessage, Exception, string> OnRespondingFromRemoteServer { get; set; }
        ...
        public void OnResponseFromRemoteServer(Action<string, string, HttpRequestMessage, HttpResponseMessage, Exception, string> onAction)
        {
